...
# inverse dataflow - process one video frame at a time
def inverse_get_train_dataflow_davis(video, frame_num, add_mask=False):
    train_img_path = "/home/hs12/Thesis/data/DAVIS/JPEGImages/480p/"
    train_label_path = "/home/hs12/Thesis/data/DAVIS/Annotations/480p/"
    if frame_num < 10:
        frame = "0000" + str(frame_num)
    elif frame_num < 100:
        frame = "000" + str(frame_num)
    elif frame_num < 1000:
        frame = "00" + str(frame_num)
    
    path_imgs = train_img_path + str(video) + "/" + frame + ".jpg"
    imgs = sorted(glob.glob(path_imgs))
    ...
    def preprocess(fname):
        #print("start preproc davis",fname) 
        start = time.time()
        ...
        add_mask = True # added by Hari 
        if add_mask:
            #print("Adding Mask")
            #do_flip, h, w = params[1]
            #do_flip = False # added by Hari
            h, w, c = params
...
def get_train_dataflow_davis(add_mask=False):
    ...
    train_img_path = "/home/hs12/Thesis/data/DAVIS/JPEGImages/480p/"
    train_label_path = "/home/hs12/Thesis/data/DAVIS/Annotations/480p/"
    #train_label_path = "/home/hs12/Thesis/coarse_masks/"
    #train_coarse_label_path = '/home/hs12/Thesis/coarse_masks/'
...
def preproc_img(fname, boxes, klass, second_klass, is_crowd, aug):
    ...
    # augmentation:
    # hari wants no augmentation - get rid of params
...
if __name__ == '__main__':
    config.BASEDIR = '/home/fhertan/PReMVOS/data/coco'
    config.TRAIN_DATASET = ['train2017']
